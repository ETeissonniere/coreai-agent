...
public struct KVCacheStatistics: Sendable, Equatable {
...
public protocol InferenceEngine: Sendable {
    ...
    /// Physical KV-cache allocation and reuse telemetry.
    var kvCacheStatistics: KVCacheStatistics { get }
...
extension InferenceEngine {
    ...
    public var kvCacheStatistics: KVCacheStatistics {
        KVCacheStatistics(
            usedTokens: processedTokenCount,
            allocatedTokens: config.maxContextLength,
            maximumTokens: config.maxContextLength,
            reusedPrefixTokens: lastPrefixHitCount
        )
    }
}
